...
export class AmbiguousLifestyles extends DiagnosticRule {
    ...
    private readonly registrationMap = new Map<Constructor<unknown>, Set<LifeStyleType>>();
    ...
    trackRegistration<T>(implementation: Constructor<T>, lifestyle: LifeStyleType = LifeStyles.Transient,) {
        const lifestyles = this.registrationMap.get(implementation) || new Set<LifeStyleType>();
