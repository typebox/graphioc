...
Deno.test("Diagnostics for TornLifestyles - Singleton resolves to multiple instances", () => {
  ...
  // Act & Assert
  const warning =
    "'SingletonService' registered as Singleton is resolving to multiple instances.";
...
Deno.test("Diagnostics for TornLifestyles - Scoped resolves to same instance within different scopes", () => {
  ...
  // Act & Assert
  const warning =
    "'ScopedService' registered as Scoped is sharing instances across different scopes.";
  const validatorName = "TornLifestyles";
...
Deno.test("Diagnostics for TornLifestyles - Scoped resolves to different instances within same scope", () => {
  ...
  // Act & Assert
  const warning =
    "'ScopedService' registered as Scoped resolves to different instances within the same scope.";
  const validatorName = "TornLifestyles";
